...
C2_MODELS = [
    (20260602, Path("results/chest_baselines/C2_resnet18_compiler_compatible_binary_pool_seed20260602")),
    (20260603, Path("results/chest_baselines/C2_resnet18_compiler_compatible_binary_pool_seed20260603")),
    (20260604, Path("results/chest_baselines/C2_resnet18_compiler_compatible_binary_pool_seed20260604")),
]

C3_MODELS = [
    (20260602, Path("results/chest_baselines/C3_resnet18_naive_binary_pool_all_abnormal_seed20260602")),
    (20260603, Path("results/chest_baselines/C3_resnet18_naive_binary_pool_all_abnormal_seed20260603")),
    (20260604, Path("results/chest_baselines/C3_resnet18_naive_binary_pool_all_abnormal_seed20260604")),
]

OUT_SEED = Path("results/tables/chest_resnet18_c2_vs_c3_on_c2test_seed_results.csv")
OUT_AGG = Path("results/tables/chest_resnet18_c2_vs_c3_on_c2test_aggregate.csv")
OUT_REPORT = Path("results/tables/chest_resnet18_c2_vs_c3_on_c2test_report.md")
...
def eval_model(model_dir, split_df):
    ...
    model = build_resnet18(len(label_to_idx))
...
def main():
    ...
    lines = []
    lines.append("# Chest Fair Test Comparison: C2 vs C3 on Same C2 Test Set\n")
    ...
    print("===== CHEST FAIR C2 TEST COMPARISON COMPLETE =====")
    ...
    print(f"C2 - C3_on_C2test macro F1 difference: {diff:.4f}")
